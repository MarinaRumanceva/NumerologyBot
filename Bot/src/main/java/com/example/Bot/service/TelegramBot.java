                    ...
                    switch (messageText) {
                        ...
                        case "/psquare":
                            ...
                            for (int i = 0; i < countDigits.length; i++) {
                                sendMessage(chatId, "В Вашей психоматрице цифра " + String.format("%d", i+1) + " встречается " + countDigits[i] + " раз(а) \n\n");
                                //Единицы
