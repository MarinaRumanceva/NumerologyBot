    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            switch (currentState) {
                case BASE:
                    switch (messageText) {
                        ...
                        case "/lpnumber":
                            ...
                            break;
                        case "/compatibility":
                            sendMessage(chatId, "Пожалуйста, введите две даты рождения в формате 'ДД.ММ.ГГГГ ДД.ММ.ГГГГ'.");
                ...
                case WAITING_FOR_BIRTHDATE4:
                    if ((messageText.length() == 21) && (isValidDate(messageText.substring(0, 10))) && (isValidDate(messageText.substring(11, 21)))) {
                        int lpnumber1 = lifePathNumber(messageText.substring(0, 10));
                        int lpnumber2 = lifePathNumber(messageText.substring(11, 21));
                        switch (lpnumber1) {
                            case 1:
                                if (lpnumber2 == 1) {
